...
export default function LiveMap({ fromKey, toKey, progress = 0.4, live = false, height = 300 }) {
  const from = useMemo(() => coordFor(fromKey), [fromKey])
  const to = useMemo(() => coordFor(toKey, [12.9716, 77.7]), [toKey])
